...
Begin VB.MDIForm BkgdWindow 
   ...
   BackColor       =   &H00808000&
   Caption         =   "Legacy Power Prompts 1.0 Installer"
   ClientHeight    =   5790
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   10935
...
Private Sub MDIForm_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  ...
  If (vars.QVal = True) Then
    result = MsgBox("If you exit now, your changes will be discarded. Are you sure that you want to exit LegacyPowerPrompts Installer?", vbQuestion + vbYesNo, "Exit LegacyPowerPrompts - Confirmation")
