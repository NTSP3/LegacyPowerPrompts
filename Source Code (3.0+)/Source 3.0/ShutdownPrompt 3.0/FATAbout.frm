...
Begin VB.Form FATAbout 
   ...
   Caption         =   "About LegacyPowerPrompts"
   ClientHeight    =   3585
   ClientLeft      =   2340
   ClientTop       =   1935
   ClientWidth     =   5730
   ...
   Begin VB.Label lblDescription 
      Caption         =   "The LegacyPowerPrompts application allows you to bring back the old Windows shutdown prompts in modern versions of Windows."
      ForeColor       =   &H00000000&
      Height          =   1170
      Left            =   1050
      TabIndex        =   2
