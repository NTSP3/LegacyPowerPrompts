...
Begin VB.Form Uninstall 
   ...
   Begin VB.PictureBox Picture4 
      ...
      Begin VB.Label Label12 
         BackStyle       =   0  'Transparent
         Caption         =   "LPP uninstaller Version 2.0"
         Height          =   255
         Left            =   0
         TabIndex        =   5
         Top             =   360
...
Private Sub Form_Load()
  ...
  If result = vbYes Then
    ...
    If (vars.unInsPath = "") Then
      Timer1.Enabled = False
      Timer2.Enabled = False
      Timer3.Enabled = False
      Timer4.Enabled = False
      Timer5.Enabled = False
      MsgBox "Uninstaller path is blank.", vbCritical, "Error"
      End
    ElseIf (Len(vars.unInsPath) < 3) Then
      Timer1.Enabled = False
      Timer2.Enabled = False
      Timer3.Enabled = False
      Timer4.Enabled = False
      Timer5.Enabled = False
      MsgBox "Uninstaller path is too short.", vbCritical, "Error"
      End
    ElseIf Not (Mid(vars.unInsPath, 2, 2) = ":\") Then
      Timer1.Enabled = False
      Timer2.Enabled = False
      Timer3.Enabled = False
      Timer4.Enabled = False
      Timer5.Enabled = False
      MsgBox "Uninstaller path is invalid.", vbCritical, "Error"
      End
    End If
...
Private Sub Timer4_Timer()
  ...
  ElseIf (TCount = 9) Then
    ...
    SaveSetting "LPowerPrompts", "Type", "ShadowType", "0"
    SaveSetting "LPowerPrompts", "Type", "IsMovable", "0"
    SaveSetting "LPowerPrompts", "Type", "Disabled", "0"
    SaveSetting "LPowerPrompts", "Info", "InstalledPath", "0"
    SaveSetting "LPowerPrompts", "Configs", "EnableAnimation", "0"
    SaveSetting "LPowerPrompts", "Configs", "QSetStyle", "0"
    ...
    CreateObject("WScript.Shell").RegDelete "HKCU\Software\VB and VBA Program Settings\LPowerPrompts\Type\ShadowType"
    CreateObject("WScript.Shell").RegDelete "HKCU\Software\VB and VBA Program Settings\LPowerPrompts\Type\IsMovable"
    CreateObject("WScript.Shell").RegDelete "HKCU\Software\VB and VBA Program Settings\LPowerPrompts\Type\Disabled"
    CreateObject("WScript.Shell").RegDelete "HKCU\Software\VB and VBA Program Settings\LPowerPrompts\Info\InstalledPath"
    CreateObject("WScript.Shell").RegDelete "HKCU\Software\VB and VBA Program Settings\LPowerPrompts\Configs\EnableAnimation"
    CreateObject("WScript.Shell").RegDelete "HKCU\Software\VB and VBA Program Settings\LPowerPrompts\Configs\QSetStyle"
