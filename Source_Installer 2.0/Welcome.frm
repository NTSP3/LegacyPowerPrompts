...
Begin VB.Form Welcome 
   ...
   Caption         =   "LegacyPowerPrompts Installer"
   ClientHeight    =   7260
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10305
...
Private Sub Timer4_Timer()
  ...
  ElseIf (TCount = 10) Then
    ...
    SaveSetting "LPowerPrompts", "Type", "ShadowType", "50"
    SaveSetting "LPowerPrompts", "Type", "IsMovable", "False"
    SaveSetting "LPowerPrompts", "Info", "InstalledPath", vars.InsPath
    SaveSetting "LPowerPrompts", "Configs", "EnableAnimation", "True"
    SaveSetting "LPowerPrompts", "Configs", "QSetStyle", "51"
